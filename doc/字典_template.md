    ...
    cfg.shops.interval_refresh_goods.groups_[1001].forEach(r =>
        a[r.interval] === undefined ?
            ...
            a[r.interval].push({
                ...
                "jade": cfg.item_definition.item.map_[parseInt(cfg.shops.goods.map_[r.goods_id].price.substr(0, 6))].name_chs
            })
    )
    a
}
...
|   Saber   |  逍遥散人   |    无    |  伊芙  |
|  Lancer   |  永雏塔菲   |    无    |  一姬  |
|  Archer   |  赫萝老师   |  pane   | 泷川夏彦 |
|   Rider   |  菠萝赛东°  | 赤五教教主亮亮 | 辉夜姬  |
|  Caster   | Asaki大人 |  pane   |  卡维  |
| Assassin  | 火龙果说电影  |   傅红雪   | A-37 |
| Berserker |  杆菌无敌   | 火龙果说电影  | 凉宫杏树 |
|    总决赛    |  异灵术老师  |   傅红雪   | (全部) |
