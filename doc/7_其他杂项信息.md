...
```js
!function () {
   let activity_id = 251190, activity_type = "bingo";
   ...
   cfg.activity[transform[activity_type]].forEach(function (x) {
      if (activity_type === "bingo") {
         ...
         let gacha_pool = 0;
         for (let i in cfg.activity.gacha_activity_info.map_)
            if (cfg.activity.gacha_activity_info.map_[i].activity_id === activity_id) {
               gacha_pool = cfg.activity.gacha_activity_info.map_[i].gacha_pool;
               break;
            }
