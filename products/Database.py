...
char_unique_views = {
    ...
    20000112: generate_frame(30550030) + generate_views([1, 2, 5], [30520009, 30530009, 30550030]),
    ...
    20000108: generate_views([0, 1, 2, 6, 7], [308043, 308041, 308042, 308044, 308045]),
    20000109: generate_views([0, 1, 2, 6, 7], [308043, 308041, 308042, 308044, 308045]),
    20000110: generate_views([0, 1, 2, 6, 7], [308043, 308041, 308042, 308044, 308045]),
    20000111: generate_views([0, 1, 2, 6, 7], [308043, 308041, 308042, 308044, 308045]),

    ### 常驻角色
    # 一姬: 称号-一姬当千. 猫爪子认证. 立直棒-炎夏型一姬甜筒; 和牌-疾月斩; 立直-猫过留痕; 桌布-吃瓜; 牌面-猫咪雀圣
    200001: generate_title(600045) + generate_verified(1) + generate_views([0, 1, 2, 6, 13],
                                                                           [305049, 305213, 305324, 305046, 305718]),
...
char_unique_views_3P = {
    ...
    # 璃央: 和牌-静伏蛰影; 立直-曲径通幽; 头像框-星点鳞光
    20000112: generate_frame(30550030, 3) + generate_views([1, 2, 5], [30520009, 30530009, 30550030], 3),
    ...
    # 间桐樱, 远坂凛, Saber, Archer: 立直棒-胜利誓约; 和牌-咒层界・恶念祝祭; 立直-虚影祝祷; 桌布-剑之丘; 牌背-噬光之剑
    20000108: generate_views([0, 1, 2, 6, 7], [308043, 308041, 308042, 308044, 308045], 3),
    20000109: generate_views([0, 1, 2, 6, 7], [308043, 308041, 308042, 308044, 308045], 3),
    20000110: generate_views([0, 1, 2, 6, 7], [308043, 308041, 308042, 308044, 308045], 3),
    20000111: generate_views([0, 1, 2, 6, 7], [308043, 308041, 308042, 308044, 308045], 3),

    ### 常驻角色
    # 一姬: 称号-一姬当千. 猫爪子认证. 立直棒-炎夏型一姬甜筒; 和牌-疾月斩; 立直-猫过留痕; 桌布-吃瓜; 牌面-猫咪雀圣
    200001: generate_title(600045, 3) + generate_verified(1, 3) + generate_views([0, 1, 2, 6, 13],
                                                                                 [305049, 305213, 305324, 305046,
                                                                                  305718], 3),
    # 二阶堂美树: 称号-喵国大护法. 桌布-藤萝悦色
