...
declare const setDiscardTiles: (tiles: Players_Tile) => void;
declare const setDealTiles: (tiles: Players_Tile) => void;
...
declare const separate: (tiles: string | string[]) => Tile[];
...
declare let discard_tiles: Players_TileArray, deal_tiles: Players_TileArray;
...
declare let awaiting_tiles: [string?, string?, string?];
...
declare const tile2Int: (tile: Tile, type?: boolean, sptile?: boolean) => number;
declare const int2Tile: (x: number, type?: boolean) => string;
